...
import com.example.team24dungeoncrawler.model.HealthDecorator;
import com.example.team24dungeoncrawler.model.Player;
import com.example.team24dungeoncrawler.model.PlayerInterface;
...
public class jcrockettTest {
    ...
    public void testHealthDecorator() {
        ...
        assertEquals(150, playerCast.getHealth());
        //player = new HealthDecorator(player);
        player = new HealthDecorator(player);
        playerCast = (Player) player;
        assertEquals(175, playerCast.getHealth());
    }
